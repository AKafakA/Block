...
def generate_configs(num_predictors, backend_port,
                     ...
                     config_output_path,
                     user_name):
    predictor_ports = [backend_port + 100]
    for i in range(num_predictors - 1):
        # by default it should be 8100 8300 8400 ...
        # as 8200 is used by client api
        predictor_ports.append(backend_port + 100 * (i + 2))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_predictors", type=int, default=16,
                        help="Number of predictor nodes to use")
