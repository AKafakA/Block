...
- Remote automation scripts under `scripts/`:
  - `remote_run_suite.sh`: assumes `NORMAL_SCALE_SIMULATION_HOST` / `LARGE_SCALE_SIMULATION_HOST`, provisions the repo/venv, installs deps, and launches the chosen suite.
